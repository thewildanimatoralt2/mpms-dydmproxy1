(function (t, e) {
  ...
  return function (t) {
    ...
    var e = a.extend({
      name: "orientation",
      init: function (t) {
        this.callSuper(a, "init", arguments);
        this._style = r.evalCss(
          [
        ...
        var e = window.DeviceOrientationEvent && window.DeviceMotionEvent;
        if (!e) {
          t.html(
          ...
          this._$cube = t.find(".eruda-cube");
          this._$coordinates = t.find(".eruda-coordinates");
          this._$acceleration = t.find(".eruda-acceleration");
          this._$accGravity = t.find(".eruda-acceleration-including-gravity");
          this._$rotationRate = t.find(".eruda-rotation-rate");
          this._$interval = t.find(".eruda-interval");
          this._bindEvent();
        }
      },
      _bindEvent: function () {
        var e = this._$cube;
        var a = this._$coordinates;
        var o = this._$acceleration;
        var i = this._$accGravity;
        var n = this._$rotationRate;
        var d = this._$interval;
        var s = this;
        this._onDeviceorientation = function (t) {
          if (!s._isShow) return;
          e.css(
            "transform",
            "rotateX(" +
        ...
        this._onDevicemotion = function (t) {
          if (!s._isShow) return;
          ...
          d.text(t.interval + "ms");
        };
        window.addEventListener("deviceorientation", this._onDeviceorientation);
        window.addEventListener("devicemotion", this._onDevicemotion);
      },
      show: function () {
        this.callSuper(a, "show", arguments);
        this._isShow = true;
      },
      hide: function () {
        this.callSuper(a, "hide", arguments);
        this._isShow = false;
      },
      destroy: function () {
        this.callSuper(a, "destroy", arguments);
        r.evalCss.remove(this._style);
