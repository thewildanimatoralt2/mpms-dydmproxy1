    ...
    showPageFromHash(page, pageDefaultId, navItem, navItemChildren, navActive) {
        ...
        if (!foundActive) {
            ...
            if (defaultSettingItem) {
                const defaultNavLink = defaultSettingItem.querySelector(navItemChildren);
                if (defaultNavLink) {
...
class Browser {
    ...
    init() {
        ...
        <div class="tab-container" id="tab-container">
          ...
          <div class="tab-groups" id="tab-groups"></div>
          <button class="add-tab-button" id="create-tab-button">New Tab</button>
          </div>
      ...
      `;
        ...
        document
            .getElementById("create-tab-button")
    ...
    createTab(url, updateSrc = true) {
        ...
        const tab = this.ui.createElement("div", { class: "tab" }, [
            this.ui.createElement("div", { class: "tab-bg" }),
            this.ui.createElement("div", { class: "tab-content" }, [
                this.ui.createElement("span", {}, ["Untitled"]),
                this.ui.createElement(
                    "button",
                    { class: "close-tab", id: `close-${id}` },
                    [
                        this.ui.createElement(
                            "span",
        ...
        const updateTabTitle = () => {
            if (iframe.contentDocument) {
                ...
                const tabTitleElement = tab.querySelector("span");
    ...
    setupSortableTabs() {
        Sortable.create(this.tabGroupsContainer, {
            group: {
                name: "tabs",
                pull: true,
                put: true,
    ...
    forward() {
        document
            .querySelector("iframe.iframe.active")
            .contentWindow.history.forward();
    }

    refresh() {
        document.querySelector("iframe.iframe.active").src = document.querySelector(
