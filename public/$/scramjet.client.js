...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    ...
    client.Trap("Element.prototype.innerHTML", {
        ...
        get (ctx) {
            if (ctx.this instanceof self.HTMLScriptElement || ctx.this instanceof self.HTMLStyleElement) {
                return ctx.get();
            }
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    client.Proxy("history.pushState", {
        apply (ctx) {
            ctx.args[2] = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.encodeUrl)(ctx.args[2], client.meta);
            ctx.call();
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    ...
    client.Trap("document.documentURI", {
        get () {
            return (0,_shared__WEBPACK_IMPORTED_MODULE_0__.decodeUrl)(self.location.href);
        },
        set () {
            return false;
        }
...
const { util: { BareClient, ScramjetHeaders, BareMuxConnection }, url: { encodeUrl, decodeUrl }, rewrite: { rewriteCss, rewriteHtml, unrewriteHtml, rewriteSrcset, rewriteJs, rewriteHeaders, rewriteWorkers, htmlRules }, CookieStore } = self.$scramjet.shared;
...
(0,_rewriter_out_rewriter_js__WEBPACK_IMPORTED_MODULE_0__.initSync)(new WebAssembly.Module(Uint8Array.from(atob(self.WASM), (c)=>c.charCodeAt(0))));
